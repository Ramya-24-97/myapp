                    ...
                    <div className="glider-contain client-testimonial-slider">
                        <div className="glider draggable">
                            <div className="glider-track">
                                <div className="client-videos shadow-box glider-slide left-2" id="cvbox-1" data-gslide="0" >
                                <div className="client-video-box">
                                    <iframe className="yt-player" id="ytiframe-1" ></iframe>
                                ...
                                </div><div className="client-videos shadow-box glider-slide left-1" id="cvbox-2" data-gslide="1" >
                                    <div className="client-video-box">
                                        <iframe className="yt-player" id="ytiframe-2" ></iframe>
                                    ...
                                    </div><div className="client-videos shadow-box glider-slide active center visible" id="cvbox-3" data-gslide="2" >
                                        <div className="client-video-box">
                                            <iframe className="yt-player" id="ytiframe-3" ></iframe>
                                        ...
                                        </div><div className="client-videos shadow-box glider-slide right-1" id="cvbox-4" data-gslide="3" >
                                            <div className="client-video-box">
                                                <iframe className="yt-player" id="ytiframe-4" ></iframe>
                                            ...
                                            </div><div className="client-videos shadow-box glider-slide right-2" id="cvbox-5" data-gslide="4" >
                                                <div className="client-video-box">
                                                    <iframe className="yt-player" id="ytiframe-5"></iframe>
                                                ...
                                                </div><div className="client-videos shadow-box glider-slide right-3" id="cvbox-6" data-gslide="5" >
                                                    <div className="client-video-box">
                                                        <iframe className="yt-player" id="ytiframe-6" ></iframe>
                                            ...
                                            <div role="tablist" className="dots glider-dots"><button data-index="0" aria-label="Page 1" role="tab" className="glider-dot"></button><button data-index="1" aria-label="Page 2" role="tab" class="glider-dot"></button><button data-index="2" aria-label="Page 3" role="tab" class="glider-dot active"></button><button data-index="3" aria-label="Page 4" role="tab" class="glider-dot"></button><button data-index="4" aria-label="Page 5" role="tab" class="glider-dot"></button><button data-index="5" aria-label="Page 6" role="tab" class="glider-dot"></button></div>
                                        </div>
